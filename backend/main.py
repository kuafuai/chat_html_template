...
def step(args):
    ...
    embedding = OpenAIEmbeddings(openai_api_key="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")
    llm = ChatOpenAI(openai_api_key="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")
